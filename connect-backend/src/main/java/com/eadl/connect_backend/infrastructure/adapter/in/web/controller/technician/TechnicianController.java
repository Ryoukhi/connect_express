...
public class TechnicianController {
         ...
         * =========================
         */
        @Operation(summary = "Récupérer les villes disponibles")
        @ApiResponses({
        ...
        public ResponseEntity<List<String>> getAvailableCities() {
                return ResponseEntity.ok(technicianService.getAvailableCities());
        }

        @Operation(summary = "Récupérer les quartiers pour une ville")
        @ApiResponses({
                        @ApiResponse(responseCode = "200", description = "Liste des quartiers"),
        })
        @GetMapping("/locations/neighborhoods")
        public ResponseEntity<List<String>> getAvailableNeighborhoods(
                        @Parameter(description = "Nom de la ville") @RequestParam String city) {
                return ResponseEntity.ok(technicianService.getAvailableNeighborhoods(city));
        }
