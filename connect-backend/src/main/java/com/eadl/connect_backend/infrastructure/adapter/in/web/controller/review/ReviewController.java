...
public class ReviewController {
    ...
    public ResponseEntity<ReviewDto> createReview(@RequestBody ReviewDto dto) {
        ...
        Review created = reviewService.createReview(clientId, dto.getRating(), dto.getComment());
    ...
    public ResponseEntity<ReviewDto> getReviewForReservation(
        ...
        Long clientId = currentUserProvider.getCurrentUserId();
        return reviewService.getReviewByClientAndReservation(clientId, reservationId)
                .map(reviewMapper::toDto)
                .map(ResponseEntity::ok)
                .orElse(ResponseEntity.notFound().build());
    }
